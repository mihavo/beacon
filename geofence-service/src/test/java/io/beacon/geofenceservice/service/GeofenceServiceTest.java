...
public class GeofenceServiceTest {
    ...
    @DisplayName("Should not return non-owned geofences")
    @WithMockBeaconUser(id = "5a308995-0fb1-4fbb-95f1-e70209466539")
    @Test
    public void shouldNotReturnOtherGeofences() {
        TestGeofenceUtils.givenSampleGeofence(geofenceRepository, null, null);
        List<GeofenceResponse> responses = geofenceService.getAllGeofences().block();

...
public class KafkaProducerConfig {
  ...
  @Bean
  public ProducerFactory<String, GeofenceNotificationEvent> producerFactory() {
  ...
  @Bean KafkaTemplate<String, GeofenceNotificationEvent> geofenceNotificationEventKafkaTemplate() {
